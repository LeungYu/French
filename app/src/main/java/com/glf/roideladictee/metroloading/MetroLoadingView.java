package com.glf.roideladictee.metroloading;
...
public class MetroLoadingView extends View {
    ...
    private List<com.glf.roideladictee.metroloading.RectIndicator> rectIndicators;
    ...
    private void createIndicators() {
        ...
        for (int i = 0; i < mNumber; i++) {
            if (mHasShadow) {
                rectIndicators.add(new com.glf.roideladictee.metroloading.RectIndicator(bodyPaint, shadowPaint));
            } else {
                rectIndicators.add(new com.glf.roideladictee.metroloading.RectIndicator(bodyPaint));
            }
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        for (com.glf.roideladictee.metroloading.RectIndicator rectIndicator : rectIndicators) {
...
//                    Log.d("mmga", "end");
    ...
    private void createAnimator(final com.glf.roideladictee.metroloading.RectIndicator indicator, int startDelay) {
    ...
    private class RectIndicatorUpdateListener implements ValueAnimator.AnimatorUpdateListener {
        ...
        private com.glf.roideladictee.metroloading.RectIndicator rectIndicator;

        public RectIndicatorUpdateListener(com.glf.roideladictee.metroloading.RectIndicator rectIndicator) {
...
//        Log.d("mmga", "canceled");
    ...
    private void colorEvaluator(float fraction, com.glf.roideladictee.metroloading.RectIndicator indicator, int startColor, int EndColor) {
